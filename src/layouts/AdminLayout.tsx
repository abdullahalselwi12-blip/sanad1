    ...
    <div className="min-h-screen bg-navy-50 dark:bg-navy-950 flex">
      ...
      >
        ...
        <div className="border-t border-navy-800 p-3 space-y-1">
          <Link
            to="/"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-navy-300 hover:bg-navy-800 hover:text-white transition-colors"
          >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-error-400 hover:bg-error-900/20 transition-colors"
          >
        ...
        <header className="sticky top-0 z-20 h-16 bg-white/80 dark:bg-navy-900/80 backdrop-blur-md border-b border-navy-100 dark:border-navy-800 flex items-center justify-between px-4 lg:px-6">
          ...
          >
            ...
            <div className="hidden sm:block">
              <p className="text-sm font-medium text-navy-700 dark:text-navy-200 max-w-[120px] truncate">
