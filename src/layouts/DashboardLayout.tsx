    ...
    <div className="min-h-screen bg-navy-50 dark:bg-navy-950 flex">
      ...
      >
        ...
        <div className="border-t border-navy-100 dark:border-navy-800 p-3 space-y-1">
          <Link
            to="/"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-navy-600 dark:text-navy-300 hover:bg-navy-50 dark:hover:bg-navy-800 transition-colors"
          >
          ...
          <button
            onClick={toggleTheme}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-navy-600 dark:text-navy-300 hover:bg-navy-50 dark:hover:bg-navy-800 transition-colors"
          >
            {theme === 'dark' ? (
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-error-600 hover:bg-error-50 dark:hover:bg-error-900/20 transition-colors"
          >
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <header className="sticky top-0 z-20 h-16 bg-white/80 dark:bg-navy-900/80 backdrop-blur-md border-b border-navy-100 dark:border-navy-800 flex items-center justify-between px-4 lg:px-6">
          ...
          <button
            ...
            className="lg:hidden text-navy-600 dark:text-navy-300"
          >
            <Menu className="w-5 h-5" />
          </button>

          <h1 className="text-lg font-semibold text-navy-900 dark:text-navy-100">
            {title}
          </h1>
