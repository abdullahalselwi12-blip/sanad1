  ...
  const handleSend = async (
    ...
    try {
      ...
      if (user) {
        ...
        // Add new conversation immediately
  ...
  const openConversation = (
    ...
    const articles: LawArticle[] =
      Array.isArray(
        ...
        ? conversation.matched_articles.map(
            (article) => ({
              id: article.id,
              article_number:
                article.number,
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 text-center relative">
          ...
          <div className="flex flex-col items-center justify-center gap-3">
            ...
            {/* ================================================= */}
            {/* Advanced Assistant Link */}
            {/* ================================================= */}

            <a
              href="https://sanad-legal-ai.vercel.app"
              target="_blank"
